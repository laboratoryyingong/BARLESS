...
h="1010",c="11101",b=/^([0-9][0-9])+$/};function ITF14(f){function e(a){for(var c=0,b=0;13>b;b++)c+=parseInt(a[b])*(3-b%2*2);return 10-c%10}function h(c){return-1==c.search(a)?!1:14==c.length?c[13]==e(c):!0}this.ITF14number=f+"";this.getText=function(){return this.ITF14number};this.valid=function(){return h(this.ITF14number)};this.encoded=function(){if(h(this.ITF14number)){var a=this.ITF14number,f="";13==a.length&&(a+=e(a));for(var f=f+b,g=0;14>g;g+=2){for(var m=a.substr(g,2),l="",q=c[m[0]],m=c[m[1]],n=0;5>n;n++)l+="1"==q[n]?"111":"1",
...
1).join(this)}};(function(f){JsBarcode=function(e,h,c,b){"string"===typeof e&&(e=document.querySelector(e));c=function(a,c){var b={},d;for(d in a)b[d]=a[d];for(d in c)b[d]=c[d];return b}(JsBarcode.defaults,c);var d=e;f&&d instanceof f&&(d=e.get(0));d instanceof HTMLCanvasElement||(d=document.createElement("canvas"));if(!d.getContext)return e;h=new window[c.format](h);if(!h.valid())throw b&&b(!1),Error("The data is not valid for the type of barcode.");var a=h.encoded(),p=function(a){var b,e;e=c.height+c.textPadding;
k.font=c.fontOptions+" "+c.fontSize+"px "+c.font;k.textBaseline="bottom";k.textBaseline="top";"left"==c.textAlign?(b=c.quite,k.textAlign="left"):"right"==c.textAlign?(b=d.width-c.quite,k.textAlign="right"):(b=d.width/2,k.textAlign="center");k.fillText(a,b,e)},k=d.getContext("2d");d.width=a.length*c.width+2*c.quite;d.height=c.height+(c.displayValue?1.3*c.fontSize:0)+c.textPadding;k.clearRect(0,0,d.width,d.height);c.backgroundColor&&(k.fillStyle=c.backgroundColor,k.fillRect(0,0,d.width,d.height));k.fillStyle=
c.lineColor;for(var g=0;g<a.length;g++){var m=g*c.width+c.quite;"1"==a[g]&&k.fillRect(m,0,c.width,c.height)}c.displayValue&&p(h.getText());uri=d.toDataURL("image/png");f&&e instanceof f?e.get(0)instanceof HTMLCanvasElement||e.attr("src",uri):e instanceof HTMLCanvasElement||e.setAttribute("src",uri);b&&b(!0)};JsBarcode.defaults={width:2,height:100,quite:10,format:"CODE128",displayValue:!1,fontOptions:"",font:"monospace",textAlign:"center",textPadding:0,fontSize:12,backgroundColor:"",lineColor:"#000"};
f&&(f.fn.JsBarcode=function(e,f,c){JsBarcode(this,e,f,c);return this})})("undefined"!=typeof jQuery?jQuery:null);
